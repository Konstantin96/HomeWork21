...
void Recvozr()
{
	...
	{
		cout << "Vy vveli " << vozrast << endl<<endl;
	}
	else
	{
		Recvozr();
...
void PreobrVShestnad(char*mas, int num)
{
	int rez, ost, step = 0;
	rez = num;
	while (rez > 15)
